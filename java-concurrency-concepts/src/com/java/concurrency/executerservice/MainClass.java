...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/*
		 * When a task can be further divided into sub tasks, we can use ForkJoinPool.
		 * To use ForkJoinPool, we have to create fork join task and extend RecursiveTask<V> (V is
		 * return value type) and implement compute method.
		 */
		FibonacciRecursiveTask forkJoinTask = new FibonacciRecursiveTask(6);
